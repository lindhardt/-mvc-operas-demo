...
namespace OperasWebSites.GeocodeService {
    ...
    public interface ILocationCheckerService {
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(BingMapsRESTToolkit.Waypoint))]
        BingMapsRESTToolkit.Location GetLocation(string address);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ILocationCheckerService/GetLocation", ReplyAction="http://tempuri.org/ILocationCheckerService/GetLocationResponse")]
        System.Threading.Tasks.Task<BingMapsRESTToolkit.Location> GetLocationAsync(string address);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ILocationCheckerServiceChannel : OperasWebSites.GeocodeService.ILocationCheckerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LocationCheckerServiceClient : System.ServiceModel.ClientBase<OperasWebSites.GeocodeService.ILocationCheckerService>, OperasWebSites.GeocodeService.ILocationCheckerService {
        ...
        public BingMapsRESTToolkit.Location GetLocation(string address) {
            return base.Channel.GetLocation(address);
        }
        
        public System.Threading.Tasks.Task<BingMapsRESTToolkit.Location> GetLocationAsync(string address) {
